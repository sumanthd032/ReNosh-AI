...
class _AcceptorDashboardState extends State<AcceptorDashboard> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchUserData() async {
    try {
      ...
      if (user != null) {
        ...
        if (doc.exists && doc.data()!['role'] == 'Food Acceptor') {
          setState(() {
            _orgName = doc.data()!['org_name'];
            _isLoading = false;
          });
        } else {
  ...
  Future<void> _claimDonation(String donationId) async {
    ...
    try {
      ...
      _showSuccessSnackBar('Donation claimed successfully.');
    } catch (e) {
      _showErrorSnackBar('Failed to claim donation.');
    } finally {
      setState(() => _isLoading = false);
    }
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 24),
                _buildSidebarItem('Donations', Icons.food_bank, () {}),
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      trailing: ElevatedButton(
                        onPressed: () => _claimDonation(doc.id),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildImpactCard('Meals Distributed', '120', Icons.food_bank, isWebLayout),
              _buildImpactCard('People Served', '300', Icons.people, isWebLayout),
            ],
          ),
        ],
      ),
